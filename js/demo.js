$(function()
{
	...
	*/
	...
	$('.singleDate_issue_date').dateRangePicker(
	{
		autoClose: true,
		singleDate : true,
		showShortcuts: false 
	}); 
	$('.singleDate_expiry_date').dateRangePicker(
	{
		autoClose: true,
		singleDate : true,
		showShortcuts: false 
	...
	.bind('datepicker-first-date-selected', function(event, obj){console.log('first-date-selected',obj);})
	.bind('datepicker-change',function(event,obj){console.log('change',obj);})
	.bind('datepicker-apply',function(event,obj){console.log('apply',obj);})
	.bind('datepicker-close',function(){console.log('before close');})
	.bind('datepicker-closed',function(){console.log('after close');})
	.bind('datepicker-open',function(){console.log('before open');})
	.bind('datepicker-opened',function(){console.log('after open');});
